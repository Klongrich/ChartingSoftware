...
import data.qoutes;
import chart.Scanner.scannerbox;
import chart.watchlist.watchlistbox;
...
public class graph extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
    ...
    //If on mac plz set this to equal true
    ...
    public graph(String tick)
    {
        ...
        add(createButton("30 Min", offset, 30, 50));
        offset += space;
        add(createButton("15 Min", offset, 15, 30));
        offset += space;
